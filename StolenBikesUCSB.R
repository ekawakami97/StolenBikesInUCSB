...
bikeParking <- read.csv("C:/Users/Eri/Documents/Data Science/BikesStolenUCSB/bikeParking.csv", header = TRUE)
...
bargraph <- ggplot(data = density) +
  geom_bar(stat = "identity", aes (x = Location, y = count), fill = "#0099cc") +
